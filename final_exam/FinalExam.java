public class FinalExam {
    public static void main(String[] args) throws Exception {
        ...
        for (char row = 0; row < array.length; row++) {
            ...
            System.out.println(" ");
            for (char column = 0; column < array.length; column++) {
        ...
        for (char row = 0; row < array.length; row++) {
            ...
            for (char column = 0; column < array.length; column++) {
                if (column == 0) {
                    if (row == 4 || row == 5 || row == 6 || row == 7 || row == 8 || row == 9) {
                        System.out.println(" ");
                    } else {
                        System.out.print(array[row][column]);
                    }
        ...
        // TIPSY - (10 points)
        System.out.println(" ");
        System.out.println("10. TIPSY ");for (char row = 0; row < array.length; row++) {
